...
-(instancetype)initWithTitile:(NSString *)tile content:(NSString *)content image1:(NSString *)urlimge1 image2:(NSString *)urlimage2 image3:(NSString *)urlimage3 andDate:(NSString *)theDate;
