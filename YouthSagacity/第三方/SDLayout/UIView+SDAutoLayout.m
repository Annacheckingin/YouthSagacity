...
- (void)sd_layoutSubviews
{
    ...
    //根据交换方法的惯例，这里实际上是调用的是真正的layoutsubviews方法；
...
- (void)sd_layoutSubviewsHandle{
    ...
    if (self.sd_equalWidthSubviews.count) {
        ...
        //设置每个view的width_sd属性和fixedwidth属性
    ...
    //假如self.sd_categoryManager.flowItems中有元素并且self.sd_categoryManager.lastWidth != self.width_sd
