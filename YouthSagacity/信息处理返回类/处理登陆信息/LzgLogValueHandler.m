...
@implementation LzgLogValueHandler
static  LzgLogValueHandler *me;
+(instancetype)shareInstance
{
    if (me==nil)
    {
        me=[[ LzgLogValueHandler alloc]init];
    }
    return me;
}
-(BOOL)logSuccess:(id)resonseObject
{
    if (resonseObject==nil)
    {
        @throw [NSException exceptionWithName:@"parameter is nil" reason:@"resonseObjec cant be nil" userInfo:nil];
    }
